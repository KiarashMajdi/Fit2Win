...
function draw() {
  image(video1, 0, 0, 700, 400);
  image(video2, 700, 0, 550, 400);
...
function getAngles()  {
  ...
  if (poses1.length > 0 && poses2.length > 0 && poses2[0].pose.score > 0.6){
    
    var pose1 = poses1[0].pose;
    var pose2 = poses2[0].pose;
    points += (checkRightHand(pose1, pose2)+ checkRightArm(pose1, pose2) + checkLeftHand(pose1, pose2) + checkLeftArm(pose1, pose2) + checkRightLeg(pose1, pose2) + checkRightFoot(pose1, pose2) + checkLeftLeg(pose1, pose2) + checkLeftFoot(pose1, pose2)) / 8;
...
function giveScore(a1, a2){
  ...
  if ((a1 - a2)< 0.15 && (a1 - a2)> -0.15){
    return 0.5
  }

  if ((a1 - a2)< 0.2 && (a1 - a2)> -0.2){
    return 0.25
  }
